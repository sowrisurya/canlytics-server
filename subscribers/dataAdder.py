...
class DataController:
	def __init__(self, frame_id: int, inpt_data_hex: str, max_clients: int = 1, callback : Callable = None) -> None:
	...
	def __vehicle_diagnostic_callback(self, client, userdata, message):
		...
		try:
			...
			print(e)
		if self.__callback:
			self.__callback(device_id, decoded_data, success_message)
